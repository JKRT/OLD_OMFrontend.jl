  module Util 
    ...
    FuncT = Function
        ...
        function applyOptionOrDefault(inValue::Option{TI}, inFunc::FuncType, inDefaultValue::TO)  where {TI, TO}
              local outValue::TO
        ...
        function applyOptionOrDefault1(inValue::Option{TI}, inFunc::FuncType, inArg::ArgT, inDefaultValue::TO)  where {TI, TO, ArgT}
              local outValue::TO
