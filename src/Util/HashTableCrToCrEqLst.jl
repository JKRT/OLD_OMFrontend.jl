  module HashTableCrToCrEqLst 
    ...
    FuncExpStr = Function
        ...
        */ =#
        ...
        function printTupleComponentRefEqListStr(cr_eq_lst::List{<:Tuple{<:DAE.ComponentRef, BackendDAE.Equation}}) ::String 
              local res::String

              res = stringDelimitList(ListUtil.map(cr_eq_lst, printTupleComponentRefEqStr), ",")
          res
        end

        function printTupleComponentRefEqStr(cr_eq::Tuple{<:DAE.ComponentRef, BackendDAE.Equation}) ::String 
              local res::String
