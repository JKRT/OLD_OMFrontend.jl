...
@importDBG Util
        ...
        function updateInstance(inRef::MMRef, inVar::DAE.Var) ::MMRef
              ...
              outRef = begin
                ...
                @matchcontinue (inRef, inVar) begin
                  ...
                  _  => begin
                        Error.addCompilerError("FGraphUtil.updateInstance failed for node: " + FNode.toPathStr(FNode.fromRef(inRef)) + " variable:") #+ Types.printVarStr(inVar))
                      fail()
                  end
                end
              end
        ...
        function openNewScope(inGraph::Graph, encapsulatedPrefix::SCode.Encapsulated, inName::Option{<:Name}, inScopeType::Option{<:FCore.ScopeType}) ::Graph
              ...
              outGraph = begin
                ...
                @matchcontinue (inGraph, encapsulatedPrefix, inName, inScopeType) begin
                  ...
                  _  => begin
                        Error.addCompilerError("FGraphUtil.openNewScope: failed to open new scope in scope: " + getGraphNameStr(inGraph) + " name: " + Util.stringOption(inName) + "\\n")
                      fail()
                  end
                end
              end
        ...
        function openScope(inGraph::Graph, encapsulatedPrefix::SCode.Encapsulated, inName::Name, inScopeType::Option{<:FCore.ScopeType}) ::Graph
              ...
              outGraph = begin
                ...
                @matchcontinue (inGraph, encapsulatedPrefix, inName, inScopeType) begin
                  ...
                  _  => begin
                        Error.addCompilerError("FGraphUtil.openScope: failed to open new scope in scope: " + getGraphNameStr(inGraph) + " name: " + inName + "\\n")
                      fail()
                  end
                end
              end
              ...
              outGraph = begin
                ...
                @matchcontinue (inGraph, inVar, inVarEl, inMod, instStatus, inCompGraph) begin
                  (_, DAE.TYPES_VAR(name = n), c, _, _, _)  => begin
                      ...
                      Error.addCompilerError("FGraphUtil.mkComponentNode: The component name: " + SCodeUtil.elementName(c) + " is not the same as its DAE.TYPES_VAR: " + n + "\\n")
                    fail()
                  end
        ...
        function setStatus(inEnv::Graph, inName::Name, inStatus::FCore.Data) ::Graph
              ...
              outEnv = begin
                ...
                @matchcontinue (inEnv, inName, inStatus) begin
                  ...
                  (g, _, _)  => begin
                      print("FGraphUtil.setStatus failed on: " + getGraphNameStr(g) + " element: " + inName + "\\n")
                    g
                  end
                end
              end
        ...
        function getStatus(inEnv::Graph, inName::Name) ::FCore.Data
              ...
              outStatus = begin
               ...
               =#
               #=  print(\"FGraphUtil.getStatus failed on: \" + getGraphNameStr(g) + \" element: \" + inName + \"\\n\");
               =#
          outStatus
        end
