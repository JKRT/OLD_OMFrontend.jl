  module HashTable6 
    ...
    FuncExpStr = Function
        ...
        */ =#
        ...
        function hashFunc(key::Key, mod::ModelicaInteger) ::ModelicaInteger 
              ...
              res = begin
                ...
                @matchcontinue (tpl1, tpl2) begin
                  ((cr11, cr12), (cr21, cr22))  => begin
                    ComponentReference.crefEqualNoStringCompare(cr11, cr21) && ComponentReference.crefEqualNoStringCompare(cr12, cr22)
                  end
                end
              end
          res
