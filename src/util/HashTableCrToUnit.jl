    ...
    FuncValueStr = Function
        ...
        */ =#
        ...
        function emptyHashTableSized(size::ModelicaInteger) ::HashTable 
              ...
              hashTable = BaseHashTable.emptyHashTableWork(size, (ComponentReference.hashComponentRefMod, ComponentReference.crefEqual, ComponentReference.printComponentRefStr, Unit.unit2string))
          hashTable
        end
