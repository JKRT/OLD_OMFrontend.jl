    ...
    InstFunc = Function
        ...
        function arrayBasictypeBaseclass(inInstDims::List{<:List{<:DAE.Dimension}}, inType::DAE.Type) ::Option{DAE.Type} 
         ...
         #= This function is used when instantiating classes in lookup of other classes.
          ...
          inherited classes. =#
        function partialInstClassIn(cache::FCore.Cache, env::FCore.Graph, ih::InnerOuter.InstHierarchy, mod::DAE.Mod, prefix::Prefix.PrefixType, state::ClassInf.State, cls::SCode.Element, visibility::SCode.Visibility, instDims::List{<:List{<:DAE.Dimension}}, numIter::ModelicaInteger) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, ClassInf.State, List{DAE.Var}} 
              local vars::List{DAE.Var}
        ...
        function instClassdefBasicType(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inStore::UnitAbsyn.InstStore, inMod2::DAE.Mod, inPrefix3::Prefix.PrefixType, inState5::ClassInf.State, className::String, inClassDef6::SCode.ClassDef, inRestriction7::SCode.Restriction, inVisibility::SCode.Visibility, inInstDims9::List{<:List{<:DAE.Dimension}}, inBoolean10::Bool, inGraph::ConnectionGraph.ConnectionGraph, inSets::Connect.Sets, instSingleCref::Option{<:DAE.ComponentRef}, info::SourceInfo, stopInst::MutableType{<:Bool} #= prevent instantiation of classes adding components to primary types =#) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, UnitAbsyn.InstStore, DAE.DAElist, Connect.Sets, ClassInf.State, List{DAE.Var}, Option{DAE.Type}, Option{SCode.Attributes}, DAE.EqualityConstraint, ConnectionGraph.ConnectionGraph} 
         ...
         #= 
          ...
          The last two arguments are the same as for instClassIn:
          implicit instantiation and implicit package/function instantiation. =#
        function instClassdef2(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inStore::UnitAbsyn.InstStore, inMod2::DAE.Mod, inPrefix3::Prefix.PrefixType, inState5::ClassInf.State, className::String, inClassDef6::SCode.ClassDef, inRestriction7::SCode.Restriction, inVisibility::SCode.Visibility, inPartialPrefix::SCode.Partial, inEncapsulatedPrefix::SCode.Encapsulated, inInstDims9::List{<:List{<:DAE.Dimension}}, inBoolean10::Bool, inCallingScope::InstTypes.CallingScope, inGraph::ConnectionGraph.ConnectionGraph, inSets::Connect.Sets, instSingleCref::Option{<:DAE.ComponentRef}, comment::SCode.Comment, info::SourceInfo, stopInst::MutableType{<:Bool} #= prevent instantiation of classes adding components to primary types =#) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, UnitAbsyn.InstStore, DAE.DAElist, Connect.Sets, ClassInf.State, List{DAE.Var}, Option{DAE.Type}, Option{SCode.Attributes}, DAE.EqualityConstraint, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outEqualityConstraint::DAE.EqualityConstraint
              local optDerAttr::Option{SCode.Attributes}
        ...
        function partialInstClassdef(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inMod::DAE.Mod, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inClass::SCode.Element #= The class this definition comes from. =#, inClassDef::SCode.ClassDef, inVisibility::SCode.Visibility, inInstDims::List{<:List{<:DAE.Dimension}}, numIter::ModelicaInteger) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, ClassInf.State, List{DAE.Var}} 
              local outVars::List{DAE.Var}
              local outState::ClassInf.State
              local outIH::InnerOuter.InstHierarchy
              local outEnv::FCore.Graph
        ...
        function updateCompeltsMods(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inComponents::List{<:Tuple{<:SCode.Element, DAE.Mod}}, inState::ClassInf.State, inBoolean::Bool) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, List{Tuple{SCode.Element, DAE.Mod}}} 
        ...
        function updateCompeltsMods_dispatch(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inComponents::List{<:Tuple{<:SCode.Element, DAE.Mod}}, inState::ClassInf.State, inBoolean::Bool) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, List{Tuple{SCode.Element, DAE.Mod}}} 
              local outComponents::List{Tuple{SCode.Element, DAE.Mod}}
              local outIH::InnerOuter.InstHierarchy
              local outEnv::FCore.Graph
              local outCache::FCore.Cache
         ...
         #= This function takes a DAE.Mod and an SCode.Element and if the modification
           ...
           element is returned. =#
        function redeclareType(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inMod::DAE.Mod, inElement::SCode.Element, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inImpl::Bool, inCmod::DAE.Mod) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, SCode.Element, DAE.Mod} 
        ...
        function updateComponentsInEnv(cache::FCore.Cache, env::FCore.Graph, inIH::InnerOuter.InstHierarchy, pre::Prefix.PrefixType, mod::DAE.Mod, crefs::List{<:Absyn.ComponentRef}, ci_state::ClassInf.State, impl::Bool) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy} 
              local outIH::InnerOuter.InstHierarchy = inIH
        ...
        function updateComponentInEnv(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, pre::Prefix.PrefixType, mod::DAE.Mod, cref::Absyn.ComponentRef, inCIState::ClassInf.State, impl::Bool, inUpdatedComps::Option{<:HashTable5.HashTable}, currentCref::Option{<:Absyn.ComponentRef} #= The cref that caused this call to updateComponentInEnv. =#) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, Option{HashTable5.HashTable}} 
        ...
        function instConstraints(inCache::FCore.Cache, inEnv::FCore.Graph, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inConstraints::List{<:SCode.ConstraintSection}, inImpl::Bool) ::Tuple{FCore.Cache, FCore.Graph, DAE.DAElist, ClassInf.State} 
              local outState::ClassInf.State
              local outDae::DAE.DAElist
              local outEnv::FCore.Graph
              local outCache::FCore.Cache
        ...
        function removeSelfReferenceAndUpdate(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inStore::UnitAbsyn.InstStore, inRefs::List{<:Absyn.ComponentRef}, inRef::Absyn.ComponentRef, inPath::Absyn.Path, inState::ClassInf.State, iattr::SCode.Attributes, inPrefixes::SCode.Prefixes, impl::Bool, inInstDims::List{<:List{<:DAE.Dimension}}, pre::Prefix.PrefixType, mods::DAE.Mod, scodeMod::SCode.Mod, info::SourceInfo) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, UnitAbsyn.InstStore, List{Absyn.ComponentRef}} 
