  module ParserExt 
    ...
    using ExportAll
        ...
        function parse(filename::String, infoFilename::String, acceptedGram::ModelicaInteger, encoding::String, languageStandardInt::ModelicaInteger, runningTestsuite::Bool, libraryPath::String, lveInstance::Option{<:ModelicaInteger}) ::Absyn.Program 
         ...
         #= Parse a mos-file =#
        function parseexp(filename::String, infoFilename::String, acceptedGram::ModelicaInteger, languageStandardInt::ModelicaInteger, runningTestsuite::Bool) ::GlobalScript.Statements 
              local outStatements::GlobalScript.Statements
        ...
        function parsestring(str::String, infoFilename::String = "<interactive>", acceptedGram::ModelicaInteger, languageStandardInt::ModelicaInteger, runningTestsuite::Bool) ::Absyn.Program 
              local outProgram::Absyn.Program
        ...
        function parsestringexp(str::String, infoFilename::String = "<interactive>", acceptedGram::ModelicaInteger, languageStandardInt::ModelicaInteger, runningTestsuite::Bool) ::GlobalScript.Statements 
              local outStatements::GlobalScript.Statements
