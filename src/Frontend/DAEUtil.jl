    ...
    @UniontypeDecl functionList
        ...
        function setVariableAttributes(var::DAE.Element, varOpt::Option{<:DAE.VariableAttributes}) ::DAE.Element
              ...
              v = begin
                @match v begin
                  DAE.VAR(__)  => begin
                      @set v.variableAttributesOption = varOpt
                    v
                  end
                end
              end
              ...
              outAttr = begin
                ...
                @match attr begin
                  SOME(va && DAE.VAR_ATTR_REAL(__))  => begin
                      @set va.stateSelectOption = SOME(s)
                    SOME(va)
                  end
        ...
        function setStartOrigin(attr::Option{<:DAE.VariableAttributes}, startOrigin::Option{<:DAE.Exp}) ::Option{DAE.VariableAttributes}
              ...
              outAttr = begin
                ...
                @match attr begin
                  SOME(va && DAE.VAR_ATTR_REAL(__))  => begin
                      @set va.startOrigin = startOrigin
                    SOME(va)
                  end
        ...
        function addComponentType2(elt::DAE.Element, inPath::Absyn.Path) ::DAE.Element
              ...
              elt = begin
                ...
                @match elt begin
                  DAE.VAR(__)  => begin
                      @set elt.source = ElementSource.addElementSourceType(elt.source, inPath)
                    elt
                  end
              ...
              _ = begin
                @match func begin
                  DAE.FUNCTION(__)  => begin
                      @set func.functions = ListUtil.appendElt(iFuncDef, func.functions)
                    ()
                  end
