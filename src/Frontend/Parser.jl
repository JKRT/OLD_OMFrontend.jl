  module Parser 
    ...
    @UniontypeDecl ParserResult 
        ...
        function parse(filename::String, encoding::String, libraryPath::String = "", lveInstance::Option{<:ModelicaInteger} = NONE()) ::Absyn.Program 
         ...
         #= Parse a mos-file =#
        function parseexp(filename::String) ::GlobalScript.Statements 
        ...
        function parsestringexp(str::String, infoFilename::String = "<interactive>") ::GlobalScript.Statements 
              local outStatements::GlobalScript.Statements

              outStatements = ParserExt.parsestringexp(str, infoFilename, Config.acceptedGrammar(), Flags.getConfigEnum(Flags.LANGUAGE_STANDARD), Config.getRunningTestsuite())
          outStatements
        end
