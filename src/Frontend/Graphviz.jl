  module Graphviz
    ...
    @UniontypeDecl Node
        ...
        Children = List
         const box = ATTR("shape", "box")::Attribute
              ...
              outIdent = begin
                ...
                @match inNode begin
                  ...
                  LNODE(type_ = typ, labelLst = lbl, attributes = attr, children = children)  => begin
                      ...
                      newattr = _cons(ATTR("label", lblstr), attr)
                      out = makeNode(nm, newattr)
                      print(out)
                      dumpChildren(nm, children)
                    nm
        ...
        function makeLabel(sl::List{<:String}) ::String
              local s2::String
        ...
        function makeLabelReq(inStringLst::List{<:String}, inString::String) ::String
        ...
        function makeAttr(l::List{<:Attribute}) ::String
              local str::String
        ...
        function makeAttrReq(inAttributeLst::List{<:Attribute}, inString::String) ::String
              local outString::String
