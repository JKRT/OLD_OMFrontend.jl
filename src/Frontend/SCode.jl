  module SCode 
    ...
    @UniontypeDecl Initial 
        ...
        As in the AST, a program is simply a list of class definitions. =#
         ...
         const defaultVarAttr = ATTR(nil, POTENTIAL(), NON_PARALLEL(), VAR(), Absyn.BIDIR(), Absyn.NONFIELD())::Attributes

         const defaultParamAttr = ATTR(nil, POTENTIAL(), NON_PARALLEL(), PARAM(), Absyn.BIDIR(), Absyn.NONFIELD())::Attributes

         const defaultConstAttr = ATTR(nil, POTENTIAL(), NON_PARALLEL(), CONST(), Absyn.BIDIR(), Absyn.NONFIELD())::Attributes
