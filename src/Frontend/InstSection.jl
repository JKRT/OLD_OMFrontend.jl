    ...
    using ExportAll
        ...
        InstanceHierarchy = InnerOuter.InstHierarchy  #= an instance hierarchy =#
         ...
         #= author: LS, ELN
          ...
          to NON_INITIAL. =#
        function instEquation(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEquation::SCode.Equation, inImpl::Bool, unrollForLoops::Bool #= Unused, to comply with Inst.instList interface. =#, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
        ...
        function instEEquation(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEEquation::SCode.EEquation, inImpl::Bool, unrollForLoops::Bool #= Unused, to comply with Inst.instList interface. =#, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
         ...
         #= author: LS, ELN
          ...
          set to INITIAL. =#
        function instInitialEquation(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEquation::SCode.Equation, inImpl::Bool, unrollForLoops::Bool #= Unused, to comply with Inst.instList interface. =#, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outState::ClassInf.State
              local outSets::Connect.Sets
              local outDae::DAE.DAElist
        ...
        function instEInitialEquation(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEEquation::SCode.EEquation, inImpl::Bool, unrollForLoops::Bool #= Unused, to comply with Inst.instList interface. =#, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outState::ClassInf.State
              local outSets::Connect.Sets
              local outDae::DAE.DAElist
        ...
        function instEquationCommon(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEEquation::SCode.EEquation, inInitial::SCode.Initial, inImpl::Bool, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outState::ClassInf.State
              local outSets::Connect.Sets
              local outDae::DAE.DAElist
         ...
         #= The DAE output of the translation contains equations which in most cases
           ...
           and connection sets. =#
        function instEquationCommonWork(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEEquation::SCode.EEquation, inInitial::SCode.Initial, inImpl::Bool, inGraph::ConnectionGraph.ConnectionGraph, inFlattenOp::DAE.SymbolicOperation) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
        ...
        function handleConnectionsOperators(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inEEquation::SCode.EEquation, inInitial::SCode.Initial, inImpl::Bool, inGraph::ConnectionGraph.ConnectionGraph, flattenOp::DAE.SymbolicOperation) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outState::ClassInf.State
              local outSets::Connect.Sets
              local outDae::DAE.DAElist
        ...
        function unroll(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inIdent::Ident, inIteratorType::DAE.Type, inValue::Values.Value, inEquations::List{<:SCode.EEquation}, inInitial::SCode.Initial, inImplicit::Bool, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, DAE.DAElist, Connect.Sets, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph = inGraph
              local outSets::Connect.Sets = inSets
              local outDae::DAE.DAElist
              local outCache::FCore.Cache = inCache
        ...
        function instForStatement(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inForStatement::SCode.Statement, inSource::DAE.ElementSource, inInitial::SCode.Initial, inImpl::Bool, inUnrollLoops::Bool) ::Tuple{FCore.Cache, List{DAE.Statement}} 
        ...
        function instForStatement_dispatch(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inIterator::String, inRange::DAE.Exp, inRangeProps::DAE.Properties, inBody::List{<:SCode.Statement}, inInfo::SourceInfo, inSource::DAE.ElementSource, inInitial::SCode.Initial, inImpl::Bool, inUnrollLoops::Bool) ::Tuple{FCore.Cache, List{DAE.Statement}} 
              local outStatements::List{DAE.Statement}
              local outCache::FCore.Cache = inCache
        ...
        function instAlgorithm(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inAlgorithm::SCode.AlgorithmSection, inImpl::Bool, unrollForLoops::Bool #= we should unroll for loops if they are part of an algorithm in a model =#, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outState::ClassInf.State
              local outSets::Connect.Sets
              local outDae::DAE.DAElist
         ...
         #= Algorithms are converted to the representation defined
          ...
          This function converts an algorithm section. =#
        function instInitialAlgorithm(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inSets::Connect.Sets, inState::ClassInf.State, inAlgorithm::SCode.AlgorithmSection, inImpl::Bool, unrollForLoops::Bool #= we should unroll for loops if they are part of an algorithm in a model =#, inGraph::ConnectionGraph.ConnectionGraph) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, DAE.DAElist, Connect.Sets, ClassInf.State, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outState::ClassInf.State
              local outSets::Connect.Sets
              local outDae::DAE.DAElist
        ...
        function instConstraint(inCache::FCore.Cache, inEnv::FCore.Graph, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inConstraints::SCode.ConstraintSection, inImpl::Bool) ::Tuple{FCore.Cache, FCore.Graph, DAE.DAElist, ClassInf.State} 
              local outState::ClassInf.State
              local outDae::DAE.DAElist
              local outEnv::FCore.Graph
              local outCache::FCore.Cache
        ...
        function instStatements(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inStatements::List{<:SCode.Statement}, inSource::DAE.ElementSource, inInitial::SCode.Initial, inImpl::Bool, unrollForLoops::Bool #= we should unroll for loops if they are part of an algorithm in a model =#) ::Tuple{FCore.Cache, List{DAE.Statement}} 
              local outStatements::List{DAE.Statement}
              local outCache::FCore.Cache = inCache
        ...
        function instStatement(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inStatement::SCode.Statement, inSource::DAE.ElementSource, inInitial::SCode.Initial, inImpl::Bool, inUnrollLoops::Bool) ::Tuple{FCore.Cache, List{DAE.Statement}} 
        ...
        function loopOverRange(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, ci_state::ClassInf.State, inIdent::Ident, inValue::Values.Value, inAlgItmLst::List{<:SCode.Statement}, source::DAE.ElementSource, inInitial::SCode.Initial, inImpl::Bool, unrollForLoops::Bool #= we should unroll for loops if they are part of an algorithm in a model =#) ::Tuple{FCore.Cache, List{DAE.Statement}} 
        ...
        function instIfEqBranch(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inEquations::List{<:SCode.EEquation}, inImpl::Bool) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, ClassInf.State, List{DAE.Element}} 
        ...
        function instInitialIfEqBranch(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inEquations::List{<:SCode.EEquation}, inImpl::Bool) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, ClassInf.State, List{DAE.Element}} 
              local outEquations::List{DAE.Element}
              local outState::ClassInf.State
              local outIH::InnerOuter.InstHierarchy
              local outEnv::FCore.Graph
        ...
        function instInitialIfEqBranches(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inBranches::List{<:List{<:SCode.EEquation}}, inImpl::Bool, inAccumEqs::List{<:List{<:DAE.Element}} = nil) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, ClassInf.State, List{List{DAE.Element}}} 
              local outEquations::List{List{DAE.Element}}
              local outState::ClassInf.State
              local outIH::InnerOuter.InstHierarchy
              local outEnv::FCore.Graph
        ...
        function instConnect(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inSets::Connect.Sets, inPrefix::Prefix.PrefixType, inComponentRefLeft::Absyn.ComponentRef, inComponentRefRight::Absyn.ComponentRef, inImplicit::Bool, inGraph::ConnectionGraph.ConnectionGraph, info::SourceInfo) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, Connect.Sets, DAE.DAElist, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outDae::DAE.DAElist
              local outSets::Connect.Sets
              local outIH::InnerOuter.InstHierarchy
        ...
        function connectExpandableConnectors(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inSets::Connect.Sets, inPrefix::Prefix.PrefixType, inComponentRefLeft::Absyn.ComponentRef, inComponentRefRight::Absyn.ComponentRef, inImpl::Bool, inGraph::ConnectionGraph.ConnectionGraph, info::SourceInfo) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, Connect.Sets, DAE.DAElist, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outDae::DAE.DAElist
              local outSets::Connect.Sets
              local outIH::InnerOuter.InstHierarchy
        ...
        function connectExpandableVariables(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inSets::Connect.Sets, inPrefix::Prefix.PrefixType, inComponentRefLeft::Absyn.ComponentRef, inComponentRefRight::Absyn.ComponentRef, inVariablesUnion::List{<:String}, inImpl::Bool, inGraph::ConnectionGraph.ConnectionGraph, info::SourceInfo) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, Connect.Sets, DAE.DAElist, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outDae::DAE.DAElist
              local outSets::Connect.Sets
              local outIH::InnerOuter.InstHierarchy
        ...
        function connectComponents(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inSets::Connect.Sets, inPrefix3::Prefix.PrefixType, cr1::DAE.ComponentRef, inFace5::Connect.Face, inType6::DAE.Type, vt1::SCode.Variability, cr2::DAE.ComponentRef, inFace8::Connect.Face, inType9::DAE.Type, vt2::SCode.Variability, inConnectorType::DAE.ConnectorType, io1::Absyn.InnerOuter, io2::Absyn.InnerOuter, inGraph::ConnectionGraph.ConnectionGraph, info::SourceInfo) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, Connect.Sets, DAE.DAElist, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outDae::DAE.DAElist
              local outSets::Connect.Sets
              local outIH::InnerOuter.InstHierarchy
        ...
        function connectVars(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inSets::Connect.Sets, inPrefix::Prefix.PrefixType, inComponentRef3::DAE.ComponentRef, inFace4::Connect.Face, inTypesVarLst5::List{<:DAE.Var}, vt1::SCode.Variability, inComponentRef6::DAE.ComponentRef, inFace7::Connect.Face, inTypesVarLst8::List{<:DAE.Var}, vt2::SCode.Variability, inConnectorType::DAE.ConnectorType, io1::Absyn.InnerOuter, io2::Absyn.InnerOuter, inGraph::ConnectionGraph.ConnectionGraph, info::SourceInfo) ::Tuple{FCore.Cache, FCore.Graph, InnerOuter.InstHierarchy, Connect.Sets, DAE.DAElist, ConnectionGraph.ConnectionGraph} 
              local outGraph::ConnectionGraph.ConnectionGraph
              local outDae::DAE.DAElist
              local outSets::Connect.Sets
              local outIH::InnerOuter.InstHierarchy
        ...
        function instParForStatement(inCache::FCore.Cache, inEnv::FCore.Graph, inIH::InnerOuter.InstHierarchy, inPrefix::Prefix.PrefixType, inState::ClassInf.State, inForStatement::SCode.Statement, inSource::DAE.ElementSource, inInitial::SCode.Initial, inImpl::Bool, inUnrollLoops::Bool) ::Tuple{FCore.Cache, List{DAE.Statement}} 
              local outStatements::List{DAE.Statement} #= For statements can produce multiple statements due to unrolling. =#
              local outCache::FCore.Cache
