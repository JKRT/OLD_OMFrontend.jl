  module OperatorOverloading 
    ...
    using ExportAll
         ...
         * arrays of the basic types. */ =#
         constVar intarrtypes = list(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_INTEGER_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())))::List
         #=  1-dim
         =#
         #=  2-dim
         =#
         ...
         #=  9-dim
         =#
         constVar stringarrtypes = list(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())), list(DAE.DIM_UNKNOWN())))::List
         #=  1-dim
         =#
         #=  2-dim
         =#
         ...
         constVar inttypes = list(DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT, DAE.T_INTEGER_DEFAULT)::List
         constVar realtypes = list(DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT, DAE.T_REAL_DEFAULT)::List
         constVar stringtypes = list(DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT)::List
          ...
          (cache, exps)
              ...
              module OperatorsBinary 
                ...
                using ExportAll
                     ...
                     constVar int_scalar = DAE.T_INTEGER_DEFAULT::DAE.Type
                     constVar real_scalar = DAE.T_REAL_DEFAULT::DAE.Type
                     constVar bool_scalar = DAE.T_BOOL_DEFAULT::DAE.Type
                     constVar int_mul = DAE.MUL(int_scalar)::DAE.Operator
                     constVar real_mul = DAE.MUL(real_scalar)::DAE.Operator
                     constVar real_div = DAE.DIV(real_scalar)::DAE.Operator
                     constVar real_pow = DAE.POW(real_scalar)::DAE.Operator
                     constVar int_mul_sp = DAE.MUL_SCALAR_PRODUCT(int_scalar)::DAE.Operator
                     constVar real_mul_sp = DAE.MUL_SCALAR_PRODUCT(real_scalar)::DAE.Operator
                     constVar int_mul_mp = DAE.MUL_MATRIX_PRODUCT(DAE.T_INTEGER_DEFAULT)::DAE.Operator
                     constVar real_mul_mp = DAE.MUL_MATRIX_PRODUCT(DAE.T_REAL_DEFAULT)::DAE.Operator
                     constVar int_vector = DAE.T_ARRAY(int_scalar, list(DAE.DIM_UNKNOWN()))::DAE.Type
                     constVar int_matrix = DAE.T_ARRAY(int_vector, list(DAE.DIM_UNKNOWN()))::DAE.Type
                     constVar real_vector = DAE.T_ARRAY(real_scalar, list(DAE.DIM_UNKNOWN()))::DAE.Type
                     constVar real_matrix = DAE.T_ARRAY(real_vector, list(DAE.DIM_UNKNOWN()))::DAE.Type
                     constVar addIntArrays = list((DAE.ADD_ARR(int_vector), list(at, at), at) for at in intarrtypes)::List
                     constVar addRealArrays = list((DAE.ADD_ARR(real_vector), list(at, at), at) for at in realarrtypes)::List
                     constVar addStringArrays = list((DAE.ADD_ARR(DAE.T_ARRAY(DAE.T_STRING_DEFAULT, list(DAE.DIM_UNKNOWN()))), list(at, at), at) for at in stringarrtypes)::List
                     constVar addScalars = list((DAE.ADD(int_scalar), list(int_scalar, int_scalar), int_scalar), (DAE.ADD(real_scalar), list(real_scalar, real_scalar), real_scalar), (DAE.ADD(DAE.T_STRING_DEFAULT), list(DAE.T_STRING_DEFAULT, DAE.T_STRING_DEFAULT), DAE.T_STRING_DEFAULT))::List
                     constVar addTypes = listAppend(addScalars, listAppend(addIntArrays, listAppend(addRealArrays, addStringArrays)))::List
                     constVar addIntArrayScalars = list(@do_threaded_for (DAE.ADD_ARRAY_SCALAR(int_vector), list(at, rhs), at) (at, rhs) (intarrtypes, inttypes))::List
                     constVar addRealArrayScalars = list(@do_threaded_for (DAE.ADD_ARRAY_SCALAR(real_vector), list(at, rhs), at) (at, rhs) (realarrtypes, realtypes))::List
                     constVar addStringArrayScalars = nil::List
                     constVar addEwTypes = listAppend(addIntArrayScalars, listAppend(addRealArrayScalars, listAppend(addStringArrayScalars, addTypes)))::List
                     constVar subIntArrays = list((DAE.SUB_ARR(int_vector), list(at, at), at) for at in intarrtypes)::List
                     constVar subRealArrays = list((DAE.SUB_ARR(real_vector), list(at, at), at) for at in realarrtypes)::List
                     constVar subScalars = list((DAE.SUB(int_scalar), list(int_scalar, int_scalar), int_scalar), (DAE.SUB(real_scalar), list(real_scalar, real_scalar), real_scalar))::List
                     constVar subTypes = listAppend(subScalars, listAppend(subIntArrays, subRealArrays))::List
                     constVar subIntArrayScalars = list(@do_threaded_for (DAE.SUB_SCALAR_ARRAY(int_vector), list(lhs, at), at) (at, lhs) (intarrtypes, inttypes))::List
                     constVar subRealArrayScalars = list(@do_threaded_for (DAE.SUB_SCALAR_ARRAY(real_vector), list(lhs, at), at) (at, lhs) (realarrtypes, realtypes))::List
                     constVar subEwTypes = listAppend(subScalars, listAppend(subIntArrayScalars, listAppend(subRealArrayScalars, listAppend(subIntArrays, subRealArrays))))::List
                     constVar mulScalars = list((int_mul, list(int_scalar, int_scalar), int_scalar), (real_mul, list(real_scalar, real_scalar), real_scalar))::List
                     constVar mulScalarProduct = list((int_mul_sp, list(int_vector, int_vector), int_scalar), (real_mul_sp, list(real_vector, real_vector), real_scalar))::List
                     constVar mulMatrixProduct = list((int_mul_mp, list(int_vector, int_matrix), int_vector), (int_mul_mp, list(int_matrix, int_vector), int_vector), (int_mul_mp, list(int_matrix, int_matrix), int_matrix), (real_mul_mp, list(real_vector, real_matrix), real_vector), (real_mul_mp, list(real_matrix, real_vector), real_vector), (real_mul_mp, list(real_matrix, real_matrix), real_matrix))::List
                     constVar mulIntArrayScalars = list(@do_threaded_for (DAE.MUL_ARRAY_SCALAR(int_vector), list(at, rhs), at) (at, rhs) (intarrtypes, inttypes))::List
                     constVar mulRealArrayScalars = list(@do_threaded_for (DAE.MUL_ARRAY_SCALAR(real_vector), list(at, rhs), at) (at, rhs) (realarrtypes, realtypes))::List
                     constVar mulTypes = listAppend(mulScalars, listAppend(mulIntArrayScalars, listAppend(mulRealArrayScalars, listAppend(mulScalarProduct, mulMatrixProduct))))::List
                     constVar mulIntArray = list((DAE.MUL_ARR(int_vector), list(at, at), at) for at in intarrtypes)::List
                     constVar mulRealArray = list((DAE.MUL_ARR(real_vector), list(at, at), at) for at in realarrtypes)::List
                     constVar mulEwTypes = listAppend(mulScalars, listAppend(mulIntArrayScalars, listAppend(mulRealArrayScalars, listAppend(mulIntArray, mulRealArray))))::List
                     constVar divTypes = _cons((real_div, list(real_scalar, real_scalar), real_scalar), list(@do_threaded_for (DAE.DIV_ARRAY_SCALAR(real_vector), list(at, rhs), at) (at, rhs) (realarrtypes, realtypes)))::List
                     constVar divRealScalarArray = list(@do_threaded_for (DAE.DIV_SCALAR_ARRAY(real_vector), list(lhs, at), at) (at, lhs) (realarrtypes, realtypes))::List
                     constVar divArrs = list((DAE.DIV_ARR(real_vector), list(at, at), at) for at in realarrtypes)::List
                     constVar divEwTypes = listAppend(divTypes, listAppend(divRealScalarArray, divArrs))::List
                     constVar powTypes = list((real_pow, list(real_scalar, real_scalar), real_scalar), (DAE.POW_ARR(real_scalar), list(real_matrix, int_scalar), real_matrix))::List
                     constVar andTypes = _cons((DAE.AND(bool_scalar), list(bool_scalar, bool_scalar), bool_scalar), list(@do_threaded_for (DAE.AND(bool_scalar), list(at, at), at) (at) (boolarrtypes)))::List
                     constVar orTypes = _cons((DAE.OR(bool_scalar), list(bool_scalar, bool_scalar), bool_scalar), list(@do_threaded_for (DAE.OR(bool_scalar), list(at, at), at) (at) (boolarrtypes)))::List
                     #=  ADD
                     =#
                     #=  ADD_EW
                     =#
        ...
        function isOperatorBinaryFunctionOrWarn(ty::DAE.Type, info::SourceInfo) ::Bool 
              ...
              isBinaryFunc = begin
               ...
               #=  Unary functions are legal even if we are not interested in them
               =#
        ...
        function makeCallFillRestDefaults(path::Absyn.Path, inExps::List{<:DAE.Exp}, restArgs::List{<:DAE.FuncArg}, attr::DAE.CallAttributes) ::DAE.Exp 
              ...
              exps = listAppend(inExps, ListUtil.mapMap(restArgs, Types.funcArgDefaultBinding, Util.getOption))
        ...
        function isValidMatrixProductDims(dim1::DAE.Dimension, dim2::DAE.Dimension) ::Bool 
              ...
              res = Expression.dimensionsKnownAndEqual(dim1, dim2) || ! (Expression.dimensionKnown(dim1) || Expression.dimensionKnown(dim2)) || Flags.getConfigBool(Flags.CHECK_MODEL) && Expression.dimensionsEqual(dim1, dim2)
               #=  Naturally dimensions 1 and 1 are equal
               =#
        ...
        function binaryCastConstructor(inCache::FCore.Cache, env::FCore.Graph, inExp1::DAE.Exp, inExp2::DAE.Exp, inType1::DAE.Type, inType2::DAE.Type, exps::List{<:Tuple{<:DAE.Exp, Option{<:DAE.Type}}}, types::List{<:DAE.Type}, info::SourceInfo) ::Tuple{FCore.Cache, List{Tuple{DAE.Exp, Option{DAE.Type}}}} 
              ...
              (cache, resExps) = begin
               ...
               #=  We already have exactly 1 match, so don't look for more
               =#
